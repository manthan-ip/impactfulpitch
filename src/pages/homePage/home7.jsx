            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center justify-center px-4 py-1 mb-4 rounded-full bg-gray-800 backdrop-blur-sm text-white text-sm transform transition-transform duration-500 hover:scale-105">
                        ...
                        <span className="font-medium text-blue-300">Become a Part</span>
                    </div>
                ...
                <div className="grid grid-cols-12 gap-5 mb-12">
                    {/* 4+ Conferences */}
                    <div className="col-span-12 md:col-span-4 lg:col-span-3 row-span-1 bg-gray-900 text-white rounded-xl overflow-hidden flex flex-col shadow-lg">
                    ...
                    {/* 10,000+ Decks */}
                    <div className="col-span-12 md:col-span-4 lg:col-span-3 bg-gray-900 text-white rounded-xl overflow-hidden shadow-lg">
                        <div className="p-6 h-full flex flex-col">
                            <h3 className="text-4xl font-bold text-white mb-2">10,000+</h3>
                            <p className="text-gray-200 text-xl font-medium mb-3">Decks</p>
                            <p className="text-gray-300 text-sm">Discover the immense impact of our brand in the startup community and how we are disrupting the field</p>
                        </div>
                    </div>
