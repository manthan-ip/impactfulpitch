...
import {caseStudies as caseStudiesOnHomePage} from "../homePage/SuccessStories";
...
function CaseStudyCard({ image, title, description, index, isVisible, link }) {
 ...
 const caseStudiesExtra = [
  {
    image: "https://placehold.co/600x400/cccccc/969696?text=Nutrition+Brand+Fitspire",
    title: "Nutrition Brand Fitspire Raises $1 Mn In Pre-Series A Round",
    link: "/case-studies/algobulls"
  },
  {
    image: "https://placehold.co/600x400/cccccc/969696?text=Wasteful+Insights",
...
export default function SuccessStories() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-16 mt-16 pb-24 px-8 relative overflow-hidden"
    >      
